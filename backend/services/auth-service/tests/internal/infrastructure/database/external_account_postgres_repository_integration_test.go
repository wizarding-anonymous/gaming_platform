// File: backend/services/auth-service/tests/internal/infrastructure/database/external_account_postgres_repository_integration_test.go
package database
