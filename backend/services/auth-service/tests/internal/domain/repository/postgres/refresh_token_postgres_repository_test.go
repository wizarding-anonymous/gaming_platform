// File: backend/services/auth-service/tests/internal/domain/repository/postgres/refresh_token_postgres_repository_test.go
...
import (
	...
	"github.com/wizarding-anonymous/gaming_platform/backend/services/auth-service/internal/infrastructure/security" // For hashing tokens
